...
def main():
    ...
    for seed in args.seeds:
        ...
        # save incrementally so a crash on a later seed doesn't lose earlier data
        ...
        log_path.write_text(json.dumps(partial_log, indent=2, default=float))
        print(f"  (saved {log_path} after seed {seed})")
